...
ggplot(quakes.count,aes(x = mag.binned, y = N)) + 
  ...
  ggtitle("Number of Earthquakes and Respective Magnitudes")
...
```{r}
a = unname(coef(lm.quakes)[1])
b = unname(coef(lm.quakes)[2])
a - b
```
...
> ***we are 95% confident that the true y intercept is contained in the range 8.527 to 8.789, while the true slope is contained between -1.064 and -1.023***
...
> ***There are approximately 455,000,000 earthquakes in total every year***
